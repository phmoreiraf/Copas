...
class ordenar {
    ...
    public static void bolha(Jogo[] array) {
        int n = array.length;
        for (int i = (n - 1); i > 0; i--) {
            for (int j = 0; j < i; j++) {
                if (comparacao(array[j], array[j + 1])) {
...
public class CopasBolhas {
    ...
    public static void main(String[] args) throws Exception {
        ...
        arquivoEscrita = new ArquivoTextoEscrita("769233_bolha.txt");
        ...
        /*
         * try {
         * File log = new File("769233_bolha.txt");
         * String str = String.format("769233\t%d\t%d\t%d", tempoFinal,
         * ordenar.comparar,
         * ordenar.movimentar);
         * BufferedWriter writer = new BufferedWriter(new
         * FileWriter("769233_bolha.txt"));
         * writer.write(str);
