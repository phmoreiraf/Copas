...
class ordenar {
    ...
    static void mergesort(Jogo[] array, int esq, int dir) {
        if (esq < dir) {
            int meio = (esq + dir) / 2;
...
public class CopasMergesort {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ordenar.mergesort(ordenador, 0, ordenador.length - 1);
        ...
        arquivoEscrita = new ArquivoTextoEscrita("769233_mergesort.txt");
