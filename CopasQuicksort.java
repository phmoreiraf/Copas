...
public class CopasQuicksort {
    ...
    public static void main(String[] args) throws Exception {
        ...
        arquivoEscrita = new ArquivoTextoEscrita("769233_quicksort.txt");
        ...
        /*
         * try {
         * File log = new File("769233_quicksort.txt");
         * String str = String.format("769233\t%d\t%d\t%d", tempoFinal,
         * ordenar.comparar,
         * ordenar.movimentar);
         * BufferedWriter writer = new BufferedWriter(new
         * FileWriter("769233_quicksort.txt"));
         * writer.write(str);
